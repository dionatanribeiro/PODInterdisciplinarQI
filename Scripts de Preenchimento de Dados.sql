...
INSERT INTO euroschool.deficiencia VALUES (1,'Def 1',1);
INSERT INTO euroschool.deficiencia VALUES (2,'Def 2',1);
...
SELECT * FROM euroschool.aluno;
SELECT * FROM euroschool.professor;
SELECT * FROM euroschool.turma;